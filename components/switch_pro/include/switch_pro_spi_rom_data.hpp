...
static constexpr uint8_t spi_rom_data_60[] = {
    ...
    // // address 0x20
    // 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // accel_origin x, y, z
    // 0x00, 0x40, 0x00, 0x40, 0x00, 0x40, // accel_sens x, y, z
    // 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // gyro_origin x, y, z
    // 0x80, 0x3B, 0x80, 0x3B, 0x80, 0x3B, // gyro_sens x, y, z
    ...
    0x06,
    0x00,
    // address 0x30 (continuation of IMU factory calibration)
    0x09,
    0x00,
    0xe7,
    0x3b,
    ...
    0x00,
    0x08,
    0x80, // rx_center, ry_center
    0xFF,
    0xF7,
    0x7F, // rx_min, ry_min

    // 0xba, 0x15, 0x62, // left stick calibration pt.1
    // // address 0x40
    // 0x11, 0xb8, 0x7f, 0x29, 0x06, 0x5b, // left stick calibration pt2. (up to 0x45)
    // 0xff, 0xe7, 0x7e, 0x0e, 0x36, 0x56, 0x9e, 0x85, 0x60, // right stick calibration
    ...
    0xff,
    0xff,
    0xff, // left grip color
    0xff,
    0xff,
    0xff, // right grip color
    // unused
    0xff,
    0xff,
    0xff,
    ...
    // 0x0f, 0x30, 0x61, 0x96, 0x30, 0xf3, 0xd4, 0x14, 0x54, 0x41, // stick device params pt. 1
    // // address 0x90
    // 0x15, 0x54, 0xc7, 0x79, 0x9c, 0x33, 0x36, 0x63, // stick device params pt. 2
    // 0x0f, 0x30, 0x61, 0x96, 0x30, 0xf3, 0xd4, 0x14, // stick device params pt. 3 (same as pt. 1)
    // // address 0xA0
    // 0x54, 0x41, 0x15, 0x54, 0xc7, 0x79, 0x9c, 0x33, 0x36, 0x63, // stick device params pt. 4
    // (same as pt. 2)
...
static constexpr uint8_t spi_rom_data_80[] = {
    ...
    // 0xff, 0xff, 0xff,
    // 0xff, 0xff, 0xff,
    // 0xff, 0xff, 0xff, // left stick data

    // /// RIGHT STICK
    // 0xff, 0xff, // right stick magic bytes (0xB2, 0xA1) if user calibration present
    // 0xff, 0xff, 0xff,
    // 0xff, 0xff, 0xff,
    // 0xff, 0xff, 0xff, // right stick data
